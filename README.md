...
It helps in visualizing some key insights from tweets of <b>country-specific</b> or **global** users. 
...
- The **country-specific** tweets will be saved in `data\<country>\fragmented_tweets\tweets` and `data\<country>\fragmented_tweets\tweets\tweets_engagements`
- The **global** tweets will be saved in `data\global\fragmented_tweets\tweets` and `data\global\fragmented_tweets\tweets\tweets_engagements`
...
Yay! If you successfully run all the above steps, then go ahead and run the application. 
